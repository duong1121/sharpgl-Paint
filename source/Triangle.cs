...
namespace btaa
{
    internal class Triangle:Draw
    {
        public Triangle(Point pStart, Point pEnd)
        {
            base.pStart = pStart;
            base.pEnd = pEnd;
        }
        ...
        public override void DrawShape(OpenGL gl)
        {
            ...
            //Toa do dinh B
            B.X = (int)(i.X + R * Math.Cos(120 * Math.PI / 180));
            B.Y = (int)(i.Y + R * Math.Sin(120 * Math.PI / 180));

            //Toa do dinh C
            C.X = (int)(i.X + R * Math.Cos(240 * Math.PI / 180));
            C.Y = (int)(i.Y + R * Math.Sin(240 * Math.PI / 180));
